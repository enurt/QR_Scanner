  ...
  <q-page>
    ...
    <div class="row justify-center q-pt-lg">
       <div class="col-12 text-center">
        ...
        <q-btn color="blue-grey-10" rounded icon="camera_alt" label="Scan QRCode"
...
export default defineComponent ({
  ...
  computed: {
    textInfo () {
      return this.showCamera ? 'position the qrcode on the camera' : 'Click button to scan QR code.'
    }
  },
  methods: {
